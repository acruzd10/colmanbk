...
const (
	codeConst    = "modelmake:test_code"
	nameConst    = "test_name"
	nameNewConst = "test_name_2"
)

func getTestInstance() modelmake.ModelMake {
	var modelMakeInst modelmake.ModelMake

	modelMakeInst.Code = codeConst
	modelMakeInst.Name = nameConst

	return modelMakeInst
}

func compareFields(t *testing.T, objectInst *modelmake.ModelMake, newObjectInst *modelmake.ModelMake) {
...
func chkPut(t *testing.T, router *mux.Router, objectInst modelmake.ModelMake) {
...
func chkList(t *testing.T, router *mux.Router) {
	var objectList []*modelmake.ModelMake

	test_util.CheckList(t, router, ApiURL+BaseURL, &objectList)
}

func chkFields(t *testing.T, router *mux.Router, expectedObjectInst modelmake.ModelMake) {
	var newObjectInstMem modelmake.ModelMake
...
func TestModelMake(t *testing.T) {
	var origObjectInst modelmake.ModelMake = getTestInstance()
	var newObjectInst modelmake.ModelMake = getTestInstance()
